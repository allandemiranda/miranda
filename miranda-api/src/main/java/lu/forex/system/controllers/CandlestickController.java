...
public class CandlestickController implements CandlestickOperations {
  ...
  public Collection<CandlestickIndicatorsDto> getCandlesticksLimit(final @PathVariable("symbolName") String symbolName, final @PathVariable("timeFrame") TimeFrame timeFrame, final @PathVariable("limit") int limit) {
