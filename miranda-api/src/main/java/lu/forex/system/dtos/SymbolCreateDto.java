...
public record SymbolCreateDto(@NotNull @NotEmpty @NotBlank @Size(max = 6, min = 6) String name, @NotNull Currency currencyBase,
                              @NotNull Currency currencyQuote, @Min(1) @Positive int digits, double swapLong, double swapShort) implements
    Serializable {
